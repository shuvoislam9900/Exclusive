  ...
  return (
    <footer className=" bg-black mt-8 lg:mt-[140px]">
        ...
        <div className="lg:pt-[80px] pt-7 lg:mb-[60px]">
          <Flex className="justify-around flex-wrap sm:gap-4 md:gap-4 lg:gap-4">
            <div className="max-w-[217px] mb-8">
              ...
              <button className="border-none font-popins font-medium text-xl my-6 text-white">
                Subscribe
              </button>
              <h6 className=" font-popins font-normal text-base text-white">
              ...
              <div className=" relative">
                ...
                />
                <button>
                  <VscSend className="text-white text-2xl absolute top-7 right-4" />
                </button>
              </div>
            </div>
            <div className="max-w-[175px] mb-8">
              <h3 className=" font-popins font-medium text-xl text-white">
                Support
              </h3>
              <p className=" font-popins font-normal text-base text-white pt-6">
                111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.
              </p>
              <p className=" font-popins font-normal text-base text-white py-4">
                exclusive@gmail.com
              </p>
              <p className=" font-popins font-normal text-base text-white">
                +88015-88888-9999
              </p>
            </div>
            <div className="max-w-[123px] mb-8">
              <h3 className=" font-popins font-medium text-xl text-white mb-6">
                Account
              </h3>
              <Link>
                <p className=" font-popins font-normal text-base text-white mt-4">
                  My Account
                </p>
              </Link>
              <Link>
            ...
            <div className="max-w-[198px] mb-8">
              ...
              <Flex className="gap-6 mt-6">
                <Link>
                  <RiFacebookLine className="text-white text-2xl" />
                </Link>
                <Link>
      ...
      <Flex className=" border-t-2 border-[#141414] justify-center py-6 gap-2">
        <FaRegCopyright className="text-[#3d3d3d] font-normal text-base mt-1" />
        <p className="text-[#3d3d3d] font-popins font-normal text-base text-center inline">
