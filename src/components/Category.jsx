...
const Category = () => {
  return (
    <div className="pr-0 lg:pr-4">
      <List>
        <ListItem className="font-popins font-normal text-base mb-4 leading-6 flex border-b border-black lg:border-white hover:border-white duration-500 px-3 lg:px-0 justify-between items-center">
